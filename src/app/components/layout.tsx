...
export function Layout() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col selection:bg-primary/20">
      ...
      {/* Smooth Side Cart Drawer (Placeholder for now) */}
      <AnimatePresence>
        {cartDrawerOpen && (
          <>
            <motion.div
            ...
            <motion.div
              ...
              className="fixed top-4 right-4 bottom-4 w-full max-w-md bg-card z-50 rounded-3xl shadow-2xl flex flex-col border border-border/50 overflow-hidden"
            >
      ...
      {/* Page Content with smooth mount animation */}
        ...
        {chatOpen && (
          ...
          >
            ...
            <div className="flex-1 bg-muted/30 p-4 flex flex-col gap-3 overflow-y-auto">
              <div className="bg-card border border-border p-3.5 rounded-2xl rounded-tl-sm self-start text-sm shadow-sm max-w-[85%] leading-relaxed text-foreground/90">
                Halo! Saya Terra. Ada yang bisa saya bantu tentang sustainability atau produk LERA hari ini?
              </div>
            </div>
            <div className="p-3 bg-card border-t border-border flex items-center gap-2">
              <input type="text" placeholder="Tanya Terra..." className="flex-1 bg-muted/50 border border-border rounded-full px-4 py-2.5 text-sm focus:outline-none focus:border-primary/50 transition-colors" />
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="grid grid-cols-1 md:grid-cols-5 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                {["Seasonal Harvest Collection", "How It Works", "Refill System", "Ingredients"].map((link) => (
                  <li key={link}>
                    <a href="#" className="text-sm text-background/55 hover:text-background transition-colors">
                      {link}
                    </a>
                  </li>
                ))}
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link to="/login" className="text-sm text-background/55 hover:text-background transition-colors">Masuk</Link></li>
                <li><Link to="/signup" className="text-sm text-background/55 hover:text-background transition-colors">Daftar</Link></li>
          ...
          <div className="border-t border-background/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-background/35">
            ...
            <div className="flex gap-6">
              ...
              <a href="#" className="hover:text-background/60 transition-colors">Sustainability Report</a>
            </div>
          </div>
        </div>
      </footer>
